...
const Header = () => {
    ...
    return (
        ...
        <div className="w-full min-h-15 flex flex-col gap-2">
            {/* Top Header  */}
            <div className="w-full flex bg-white items-center flex-wrap justify-between gap-4 min-h-10 py-2 px-10">
            ...
            {/* Bottom Header  */}
            <div className="w-full flex flex-col bg-black text-white border-1 border-black text-sm px-10">
            <div className="w-full min-h-5 px-1 py-1 flex items-center xl:justify-between justify-end">
