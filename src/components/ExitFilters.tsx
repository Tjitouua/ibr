...
interface FilterOption {
 ...
 const ExitFilters: React.FC<FilterProps> = ({ categories, selectedExitFilters, onChange }) => {
      return (
             ...
             <div className="flex flex-col gap-3 text-gray-800 text-sm w-full">
                 ...
                 <div className="w-full flex justify-between border-b border-gray-300 pb-4 flex-wrap items-center gap-3">
                     ...
                     <div className="flex gap-2 items-center">
                        <input 
                           type="radio"
                           name={category.name} checked={selectedExitFilters[category.name as keyof typeof selectedExitFilters] === option.value}
