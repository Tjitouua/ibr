...
const ProgramsCard: React.FC<StatCardProps> = ({ title, icon, value, trend }) => {
    return (
     <div className="py-1 px-4 flex min-h-30 justify-center gap-1 w-full flex-col border border-gray-400 sm:w-70 rounded-lg">
